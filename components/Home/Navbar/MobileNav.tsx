...
const MobileNav = ({ closeNav,showNav }: props) => {
  ...
  return (
    <div>
    <div className={`fixed inset-0 ${navOpen} transform transition-all duration-500 z-[1002] bg-black opacity-70 w-full h-screen`}> </div>
        ...
        w-[70%] sm:w-[60%] bg-blue-900 space-y-6 z-[1050]`}>
            {NavLinks.map((link) =>{
                return (
             ...
             {/*  Cross icon for closing the mobile nav */}
